  ...
  return (
    <>
      ...
      <motion.aside 
        ...
        className={`fixed left-0 top-0 h-full bg-[#0f172a] border-r border-slate-800 text-white w-64 z-40 transition-transform duration-300 ease-in-out ${
      ...
      >
        <div className="flex flex-col h-full p-6">
          ...
          <div className="pt-6 border-t border-slate-800 flex justify-center gap-4">
            <a href="https://github.com/mehmet2725" target="_blank" className="text-slate-400 hover:text-white transition-colors">
                <Github size={20} />
            </a>
